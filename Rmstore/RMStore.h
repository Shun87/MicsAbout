 ...
 */
@property (nonatomic, assign) id<RMStoreReceiptVerificator> receiptVerificator;
 ...
 */
@property (nonatomic, assign) id<RMStoreTransactionObfuscator> transactionObfuscator;
